...
import { Form, Input, List, Space, Table } from "antd";
import { DateField, DeleteButton, EditButton, ShowButton } from "@refinedev/antd";
...
export const ContractorList = () => {
  ...
  const selectedProject = useProjectDetails((state) => state?.project);
    ...
    const { tableProps, tableQuery, filters, setFilters, searchFormProps} = useTable<
      IContractor,
      HttpError
    >({
      sorters: {
